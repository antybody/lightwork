	...
	var list = function(params){
		...
		var config = {
			...
			//在url后加上查询参数，如?username=sss
				"sAjaxSource":"system/users/listdepart",
			"aoColumns":[
					{ //自定义列多选框
			            "mDataProp": "id",
			            "sClass": "center",
			            'bSortable': false,
			            "mRender": function (id) {
			                return util.getTableRadio(id,"users-table");
			            }
			        },
		            { "sClass": "center", 'bSortable': false,"mDataProp": "name"},
		            { "sClass": "center", 'bSortable': false,"mDataProp": "manager", },
		            { "sClass": "center", 'bSortable': false,"mDataProp": "num" },
		            { "sClass": "center", 'bSortable': false,"mDataProp": "note" }
        		]
		};
