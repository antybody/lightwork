package com.baosight.iwater.system.bsManager.controller;
...
@RestController
@RequestMapping("/system/bsManager")
@Api(value = "/system/bsManager", description = "基础信息相关操作")
public class SystemBsManagerController {
	/*
